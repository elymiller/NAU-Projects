...
def simulate_draws_per_position(num_simulations, num_Tv, num_mutS, num_Ts):
    ...
    for _ in range(num_simulations):
        ...
        for draw_index in range(num_Tv+num_Ts):
            if not Tv_bucket:
                ...
                chosen_bucket = random.choice(['Ts', 'Tv'])
                if chosen_bucket == 'Ts':
                    chosen_ball = random.choice(Ts_bucket)
                    Ts_bucket.remove(chosen_ball)
                else:
...
if __name__ == "__main__":
    try:
        ...
        simulate_draws_per_position(num_simulations, num_Tv, num_mutS, num_Ts)
